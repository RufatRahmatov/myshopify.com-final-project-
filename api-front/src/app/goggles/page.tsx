...
const product: Product = {
  id: 1,
  name: "Clarity & Style: Discover the Perfect",
  price: 90,
  images: [
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/21_58775eab-05ad-41db-bfb8-1b65d61a275b.webp?v=1713862373&width=300",
      color: "Gray",
      price: 90,
    },
  ],
  colors: [
    { name: "Gold", price: 90 },
    { name: "White", price: 110 },
    { name: "blue", price: 120 },
    { name: "sky blue", price: 130 },
      ...
      <main>
        <div className="flex flex-wrap p-4 md:flex-nowrap md:space-x-8 px-5 mx-10 ">
          ...
          <div className="sticky top-0 flex flex-col w-full md:w-1/2 space-y-4  ">
            <p className="font-medium text-gray-600">Maxmod Goggles</p>
            <h1 className="text-3xl font-bold">{product.name}</h1>
            <p className="text-lg font-medium"> {selectedColor.price} $</p>
            <div>
            ...
            <div className="font-medium space-y-4">
              <p>
                Welcome to Eyewearlabs, where Clarity & Style converge to offer
                you the perfect optical solutions for all your eyewear needs.
                Our mission is to provide you with the finest selection of
                eyewear that not only enhances your vision but also complements
                your unique style. Whether youre seeking fashionable sunglasses
                to elevate your look or power eyewear for crystal-clear vision,
                we have you covered. Explore our curated collection of trendy
                and timeless designs, meticulously crafted using premium
