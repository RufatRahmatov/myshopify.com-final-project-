...
const product: Product = {
  id: 1,
  name: "Unveiling the Finest Optical Experience at Eyewearlabs",
  price: 110,
  images: [
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/6.webp?v=1713440677&width=533",
      color: "Gray",
      price: 120,
    },
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/4.webp?v=1713440677&width=1946",
      color: "White",
      price: 115,
    },
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/5.webp?v=1713440677&width=1946",
      color: "Brown",
      price: 125,
    },
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/7.webp?v=1713440673&width=1946",
      color: "Gold",
      price: 100,
    },
  ],
      ...
      <main>
        <div className="flex flex-wrap p-4 md:flex-nowrap md:space-x-8 px-5 mx-10 ">
          ...
          <div className="sticky top-0 flex flex-col w-full md:w-1/2 space-y-4  ">
            <p className="font-medium text-gray-600">Optical</p>
