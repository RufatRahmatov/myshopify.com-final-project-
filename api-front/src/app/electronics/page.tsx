...
const product: Product = {
  id: 1,
  name: "ClarityPrime Optical Glass with Luminix Precision",
  price: 150,
  images: [
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/20_97089cb7-390e-49a4-a78f-a22da33c2a6d.webp?v=1713441191&width=1946",
      color: "Gray",
      price: 140,
    },
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/19_67553eb4-3cd2-478c-8854-205450801ee7.webp?v=1713441191&width=1946",
      color: "White",
      price: 170,
    },
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/10_cd97773f-6152-4518-a78e-693ddc193244.webp?v=1713440953&width=533",
      color: "Brown",
      price: 180,
    },
    {
      src: "https://maxmod-goggles.myshopify.com/cdn/shop/files/13_89aa55fc-640d-405c-aecf-8d5c1fc1456d.webp?v=1713440953&width=533",
      color: "Gold",
      price: 190,
    },
  ],
      ...
      <main>
        <div className="flex flex-wrap p-4 md:flex-nowrap md:space-x-8 px-5 mx-10 ">
          ...
          <div className="sticky top-0 flex flex-col w-full md:w-1/2 space-y-4  ">
            <p className="font-medium text-gray-600">Electronics</p>
